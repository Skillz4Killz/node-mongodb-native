...
import { AutoEncrypter, MongoOptions, require } from "../../mod.ts";
 ...
 * @throws if optional 'mongodb-client-encryption'
 */
...
function createTopology(mongoClient: MongoClient, options: MongoOptions, callback: Callback<Topology>) {
  // Create the topology
